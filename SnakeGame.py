...
while True: #Infinite loop
    ...
    if my_direction == UP:#If my direction goes up
        snake[0]=(snake[0][0], snake[0][1]-10)#Decrease the 'y' by 10px
    if my_direction == DOWN:#If my direction goes down
        snake[0]=(snake[0][0], snake[0][1]+10)#Increase the 'y' by 10px
    if my_direction == RIGHT:#If my direction goes right
        snake[0]=(snake[0][0]+10, snake[0][1])#Increase the 'x' by 10px
    if my_direction == LEFT:#If my direction goes left
        snake[0]=(snake[0][0]-10, snake[0][1])#Decrease the 'x' by 10px
